...
from qugen.main.generator.tabular_qgan_model_handler import TabularQGANModelHandler
...
model_name  = 'discrete_MG_2D_copula_pit_qgan_50f4'  # example model name
new_model = TabularQGANModelHandler().reload(model_name, epoch=500)
evaluation_df = new_model.evaluate(data)
